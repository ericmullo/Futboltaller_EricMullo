...
namespace Futboltaller.Controllers
{
    ...
    {
        private readonly FutboltallerContext _context;

        public EstadiosController(FutboltallerContext context)
        {
            _context = context;
        }
        ...
        {
            var futboltallerContext = _context.Estadio.Include(e => e.Equipo);
            return View(await futboltallerContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Dirección,Ciudad,Capacidad,IdEquipo")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dirección,Ciudad,Capacidad,IdEquipo")] Estadio estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
